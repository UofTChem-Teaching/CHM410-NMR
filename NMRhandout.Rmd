...
---
Remember to write your name, and the date at the top of the report!  
...
spec <- files2SpectraObject(
  ...
  gr.crit= c("Sample", "Other", "LocalHoney", "KirklandHoney", "ManukaHoney", "MapleSyrup", "NaturoneyHoney", "NoNameHoney", "PresidentsChoiceHoney", "StarbucksHoney", "SugarSyrup"), 
...
spectralPlot <- plotSpectra(spec,
            ...
            ##Which spectra should be plotted? Your spectra is likely number 1 or 63.
            which = c(1),
